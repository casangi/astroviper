def make_image_mosaic(input_params):
    ...
    start_0 = time.time()
    import numpy as np
    from astroviper.processing_functions.visibility_manipulation.phase_shift import phase_shift_vis_ds
    from astroviper.processing_functions.imaging.make_gridding_convolution_function import (
        make_gridding_convolution_function,
    )
    from astroviper.processing_functions.imaging.make_aperture_grid import make_aperture_grid
    from astroviper.processing_functions.imaging.make_uv_sampling_grid import (
        make_uv_sampling_grid,
    )
    from xradio.image import make_empty_sky_image
    from astroviper.processing_functions.imaging.make_visibility_grid import make_visibility_grid
    from astroviper.processing_functions.imaging.fft_norm_img_xds import fft_norm_img_xds
