def calculate_briggs_params(grid_of_imaging_weights, sum_weight, imaging_weights_parms):
    ...
    if imaging_weights_parms["weighting"] == "briggs":
        ...
        briggs_factors = np.ones((2,) + sum_weight.shape) # 2 x chan x pol. Briggs denominator: briggs_factor[0,...] * G + briggs_factor[1,...] where G is the degridded weight. See grid_imaging_weights function.
