...
def residual_cycle_cube_single_field(
    ps_xdt, img_xds, input_params, is_n_iter_0
):
    """_summary_
    ...
    from astroviper.core.image_analysis.point_spread_function_gaussian_fit import point_spread_function_gaussian_fit
    ...
    img_xds, make_uv_images_single_field_return_df = make_uv_images_single_field(ps_xdt, img_xds, input_params["image_params"], cgk_1D, is_n_iter_0, ms_data_group_in_name=ps_data_group_name, img_data_group_out_name=img_data_group_name)
    ...
    img_xds["PRIMARY_BEAM"] = xr.DataArray(
        airy_disk_rorder(
            ...
            0, ...
        ][None, ...],  # Select first since we only have one dish diameter and add time axis.
...
def make_uv_images_single_field(ps_xdt, img_xds, image_params, cgk_1D, is_n_iter_0, ms_data_group_in_name="corrected", img_data_group_out_name="single_field"):
    ...
    for ms_name, ms_xdt in ps_xdt.items():
        ...
        if is_n_iter_0:
            ...
            add_uv_sampling_grid_single_field(
                ...
                img_data_group_out_modified = {"uv_sampling": "UV_SAMPLING", "uv_sampling_normalization": "UV_SAMPLING_NORMALIZATION"},
                overwrite=True,
                chan_mode="cube",
        ...
        add_visibility_grid_single_field(
            ...
            ms_data_group_in_name = ms_data_group_in_name,
            img_data_group_out_name = img_data_group_out_name,
            img_data_group_out_modified = {"visibility": "VISIBILITY", "visibility_normalization": "VISIBILITY_NORMALIZATION"},
            overwrite=True,
            chan_mode="cube",
            fft_padding=image_params["fft_padding"],
        )
