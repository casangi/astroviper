...
def get_visibility_grid_single_field(
    ...
    :func:`~astroviper.core.imaging.add_visibility_grid.add_visibility_grid_single_field`:
    ...
    See Also
    --------
    astroviper.core.imaging.add_visibility_grid.add_visibility_grid_single_field :
    ...
    from astroviper.core.imaging.gridders.prolate_spheroidal_degrid import (
        prolate_spheroidal_degrid_jit,
    )
