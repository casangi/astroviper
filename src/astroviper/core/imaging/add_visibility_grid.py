...
def add_visibility_grid_mosaic(
    ...
    img_data_group_in_name : str, default ``"mosaic"``
        ...
        :func:`~astroviper.core.imaging.add_uv_sampling_grid.add_uv_sampling_grid_mosaic`.
...
def add_visibility_grid_single_field(
    ...
    img_data_group_in_name : str, default ``"single_field"``
        Key of the image input data group in ``img_xds.attrs["data_groups"]``.
        Typically set by a preceding call to
        :func:`~astroviper.core.imaging.add_uv_sampling_grid.add_uv_sampling_grid_single_field`.
