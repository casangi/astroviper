...
def phase_shift_vis_ds_old(ms_xds, shift_params, sel_params):
    ...
    # print(ms_xds[data_group_out["uvw"]])
    ...
    # print(phase_direction.shape, ms_xds[data_group_out["uvw"]][:, :, 0:end_slice].values.shape, phase_rotation[0:end_slice].shape)
...
def calc_rotation_matrices(field_phase_direction, shift_params):
    ...
    # ra_image = shift_params["new_phase_direction"]["data"][0]
    # dec_image = shift_params["new_phase_direction"]["data"][1]
    ra_image = shift_params["new_phase_direction"].data[0]
    dec_image = shift_params["new_phase_direction"].data[1]
