"""
Tests for astroviper.processing_functions.imaging.imager — component + end-to-end.
...
Run:
    micromamba run -n astroviper_test pytest tests/unit/processing_functions/imaging/test_imager.py -v
"""
...
from astroviper.processing_functions.imaging.imager import (
    _get_param,
    _DEFAULT_PARAMS,
    grid_visibilities,
...
from astroviper.processing_functions.imaging.imaging_utils.iteration_control import (
    MAJOR_CONTINUE,
    MAJOR_ITER_LIMIT,
    MAJOR_THRESHOLD,
    MAJOR_CYCLE_LIMIT,
)
from astroviper.processing_functions.imaging.imaging_utils.return_dict import (
    ReturnDict,
    Key,
    FIELD_ACCUM,
)
from astroviper.processing_functions.imaging.imaging_utils.standard_gridding_example import (
...
class TestEndToEnd:
    ...
    def test_stops_at_threshold(self, ms4_copy, default_params):
        ...
        from astroviper.processing_functions.imaging.imaging_utils.corr_to_stokes import (
