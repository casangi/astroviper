...
Coverage:
  * Numerical agreement with the pure-Python reference (`prolate_spheroidal_grid_reference`)
...
import numpy as np
from reference_gridders import prolate_spheroidal_grid_reference
...
def _run_reference(inputs):
    ...
    prolate_spheroidal_grid_reference(
        grid,
        norm,
        inputs["vis_data"],
        inputs["uvw"],
...
class TestProlateSpheroidalGridCpp(unittest.TestCase):
    ...
    def test_matches_reference(self):
        """C++ gridder matches the pure-Python reference bit-for-bit-ish."""
    ...
    def test_serial_vs_threaded_equivalent(self):
        ...
        grid_serial, norm_serial = _run_cpp(inputs, processing_function_threads=1)
        for nt in (2, 4, 8):
            with self.subTest(processing_function_threads=nt):
                grid_t, norm_t = _run_cpp(inputs, processing_function_threads=nt)
    ...
    def test_processing_function_threads_auto_detect(self):
        ...
        grid_serial, norm_serial = _run_cpp(inputs, processing_function_threads=1)
        grid_auto, norm_auto = _run_cpp(inputs, processing_function_threads=0)
    ...
    def test_accumulates_in_place(self):
        ...
        full_grid, full_norm = _run_cpp(inputs, processing_function_threads=1)
    ...
    def test_nan_uvw_skipped(self):
        ...
        baseline_grid, baseline_norm = _run_cpp(inputs, processing_function_threads=1)
        ...
        grid_with_nan, norm_with_nan = _run_cpp(inputs2, processing_function_threads=1)
    ...
    def test_out_of_bounds_sample_skipped(self):
        ...
        inputs["uvw"][:] = 1.0e15
        grid, norm = _run_cpp(inputs, processing_function_threads=1)
...
class TestSinglePrecisionGrid(unittest.TestCase):
    ...
    def test_complex64_grid_matches_complex128(self):
        ...
        grid128, norm128 = _run_cpp(inputs, processing_function_threads=1)
    ...
    def test_complex64_grid_threaded_matches_serial(self):
        ...
        def run(processing_function_threads):
            grid = np.zeros(
                (
                    inputs["m_time"],
                    inputs["m_chan"],
...
class TestSinglePrecisionDegrid(unittest.TestCase):
    ...
    def test_complex64_grid_degrid_to_complex128_vis(self):
        ...
        grid128, _ = _run_cpp(inputs, processing_function_threads=1)
